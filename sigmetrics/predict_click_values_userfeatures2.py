...
features = dict()
features["num_primary_urls_x_user_1"] = [69]
features["num_followers_x_user_1"] = [70]
features["verified_x_user_1"] = [71]
features["num_urls_x_user_1"] = [72]
features["score_median_x_user_1"] = [89]
features["score_95_x_user_1"] = [94]
features["score_median+score_95_x_user_1"] = [89,94]
features["all_x_user_1"] = [69,70,71,72,89,94]
...
def multi_classification(cols, feature_name):
    ...
    if log_of_features:
        x_train = np.log(x_train[:,cols]+1)
        x_test = np.log(x_test[:,cols]+1)
    else:
